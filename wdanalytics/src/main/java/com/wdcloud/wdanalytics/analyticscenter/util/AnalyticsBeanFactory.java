...
public class AnalyticsBeanFactory {
    public static WdAnalyticsCrashBean getCrashWdAanlyticsFactory(){
        ...
        String updateTime = com.wdcloud.wdanalytics.util.TimeUtil.getTimeStame();
    ...
    public static void saveWdAanlyticsFactory(Context context,String project,int millis){
        com.wdcloud.wdanalytics.util.DeviceInfoUtils deviceInfoUtils = new com.wdcloud.wdanalytics.util.DeviceInfoUtils(context);
        com.wdcloud.wdanalytics.util.AnalyticsSharedPreference instance = com.wdcloud.wdanalytics.util.AnalyticsSharedPreference.getInstance();
        if(millis==0)
        {
